...
async def send_initial_message(user_id):
    messages = [
        "Здравствуйте! Вы в чате нашего ЖК писали. Я просто хочу квартиры продать, у меня их 4 в нашем ЖК, у вас есть знакомые, которые хотят купить?"
...
keywords_pattern = re.compile(
    r'\b(Квартира|Купить квартиру|Как вам ЖК|Вам нравится ЖК|Довольны ЖК)\b',
    re.IGNORECASE)
